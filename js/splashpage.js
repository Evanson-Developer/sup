...
defineheader: '<div style="padding: 5px; color: white; font: 16px Verdana; background: black url(blockdefault.png) center center repeat-x;"><a style="position:absolute; top: 2px; right: 5px" href="javascript:splashpage.closeit()" title="Skip to Content"><img src="images/skip.png" border="0" width="114px" height="23px" /></a>The Ultimate Dolphin Adventure - A Speical Presentation</div>',
