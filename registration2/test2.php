...
if ($choice1=="") {
	echo "<script language=\"JavaScript\">alert(\"Please make a selection\");</script>";
}
if ($choice1=='A') {
	echo "<form id=\"questionBox\" method=\"post\" action=\"test2.php\">";
	echo "<label class=\"persona\" for=\"element\">".$question2."</label><br />";
	echo "<input type=\"radio\" name=\"choice2\" value=\"A\" />".$answer2_1."<br />";
	echo "<input type=\"radio\" name=\"choice2\" value=\"B\" />".$answer2_2."<br />";
